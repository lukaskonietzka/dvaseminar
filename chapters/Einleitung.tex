...
Analyse zulassen, sondern für das ganze Gebiet der Datenanalyse einen hohen Wert bietet.
...
konkreten Erweiterungen ein, die wir hier näher betrachten werden. Hierzu
...
Der zweite Teil bildet den Kern der Arbeit und soll die fokussierten
Analyse-Erweiterungen anhand eines passenden Beispiels erläutern. Hierzu wird ein
globales Beispiel einer relationalen Datenbank generiert, mit deren Hilfe alle der
...
werden. So können die sehr unterschiedlichen Erweiterungen kategorisiert werden.
