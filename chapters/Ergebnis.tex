...
Diese Query liefert genau soviel Einträge wie es verschiedenen Einträger in der Spalte
...
Der erste Punkt (Gesamtverleih) ist auf die letzte Zeile zurückzuführen, die angibt, dass
