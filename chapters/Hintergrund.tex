...
demnach mit der kleinsten Menge begonnen (rechts) und auf die größte aufgerollt
(links).
...
Konzept der \texttt{CUBE} Erweiterung zurückgegriffen werden, das \citet{oracle99}
...
erstellt so Datenwürfel. Er berücksichtigt nicht die Reihenfolge, der
angegebenen Gruppierungen \citep{oracle99}.
